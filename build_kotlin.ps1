...
Write-Host "Building Kotlin only..."

$proc = Start-Process -FilePath "$projectDir\gradlew.bat" -ArgumentList "compileDebugKotlin","--no-daemon" -WorkingDirectory $projectDir -NoNewWindow -Wait -PassThru
